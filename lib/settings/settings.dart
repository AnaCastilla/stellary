                      ...
                      tiles:[
                        ExpansionTile(
                          leading: Padding(
                            ...
                            child: Image.asset('assets/notification.png', height: 26, color: Colors.white,),
                          ),
                            title: Text('Notificaciones', style: TextStyle(fontFamily: 'SourceSansPro', fontSize: 20, fontWeight: FontWeight.normal, color: Colors.white)),
                            children: [
                              Row(
                                ...
                                children: [
                                  Padding(
                                    ...
                                    child: Text(switchActivated? "Activadas" : "Desactivadas", style: TextStyle(fontFamily: 'SourceSansPro', fontSize: 17, fontWeight: FontWeight.normal, color: Colors.white)),
                                  ),
                                  Padding(
                        ...
                        ListTile(
                          leading: Icon(Icons.share),
                            title: Text('Recomendar a un amigo', style: TextStyle(fontFamily: 'SourceSansPro', fontSize: 20, fontWeight: FontWeight.normal, color: Colors.white)),
                            onTap:() {
                              Share.share('check out my website https://example.com', subject: '¡Descarga Stellary!');
                            }
                        ),
                        ListTile(
                          leading: Icon(Icons.info_outline),
                          title: Text('Sobre la aplicación', style: TextStyle(fontFamily: 'SourceSansPro', fontSize: 20, fontWeight: FontWeight.normal, color: Colors.white)),
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                        ...
                        ListTile(
                          ...
                          title: Text('Sobre mí', style: TextStyle(fontFamily: 'SourceSansPro', fontSize: 20, fontWeight: FontWeight.normal, color: Colors.white)),
                          onTap: (){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
